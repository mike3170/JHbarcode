...
import com.stit.jhbarcode.adapter.PlatingReceptionListAdapter;
...
public class PlatingReceptionQueryActivity extends AppCompatActivity {
    private String title = "電鍍接收查詢";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plating_reception_query);
    ...
    private void datePickerLsnr(View v) {
        ...
        if (TextUtils.isEmpty(this.scanDate.getText().toString())) {
            ...
            new DatePickerDialog(this, (view, year, month, dayOfMonth) -> {
                ...
                PlatingReceptionQueryActivity.this.scanDate.setText(dateFormatWithSlash.format(cal.getTime()));
            }, yy, mm, dd).show();
    ...
    private class MyTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            this.uploaded = PlatingReceptionQueryActivity.this.tbUploaded.isChecked();
            this.scanDate = PlatingReceptionQueryActivity.this.scanDate.getText().toString();
        }
            ...
            if (uploaded) {
                ...
                try {
                    String url = MyInfo.JH_API_URL +
                            "askCoilScanTemp" +
                            "?kind=" + Kind.PlatingReception.getValue() +
                            "&scanDate=" + this.scanDate;

                    //System.out.println(url);
                    url = url.replaceAll(" ", "%20");

                    ApiResponse<List<MainData>> apiResponse = Ion.with(PlatingReceptionQueryActivity.this)
                            .load("GET", url)
                ...
                mainDataList = myDao.getMainDataList(Kind.PlatingReception, _scanDate);
                return true;
            }
        }
        ...
        protected void onPostExecute(Boolean success) {
            ...
            if (success) {
                PlatingReceptionListAdapter adapter = new PlatingReceptionListAdapter(
                        PlatingReceptionQueryActivity.this,
                        mainDataList,
                        dsKind,
                        tvQueryCount
                );
