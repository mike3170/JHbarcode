...
import com.stit.jhbarcode.adapter.tracer.picklingfinished.PicklingFinishedTracerListAdapter;
 ...
 */
public class PicklingFinishedTracerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pickling_finished_tracer);
        // -------------------------------------------------
    ...
    private void doQuery(View v) {
        String jobNo = PicklingFinishedTracerActivity.this.jobOrderEt.getText()
                .toString()
                .replaceAll("\r", "")
                .replaceAll("\n", "");
        ...
        AsyncTask<Void, Void, Boolean> task = new AsyncTask<Void, Void, Boolean>() {
            ...
            protected Boolean doInBackground(Void... voids) {
                try {
                    ...
                    ApiResponse<List<ApcJobOrde>> apiResponse = Ion.with(PicklingFinishedTracerActivity.this)
                            .load(url)
            ...
            protected void onPostExecute(Boolean success) {
                if (success) {
                    ...
                    adapter = new PicklingFinishedTracerListAdapter(PicklingFinishedTracerActivity.this, tracerList);
                    recyclerView.setAdapter(adapter);

                    PicklingFinishedTracerActivity.this.countTv.setText("筆: "  +tracerList.size());
                    ...
                    PicklingFinishedTracerActivity.this.totalRequTyTv.setText("共: " + String.valueOf(totalRequQty));
                    PicklingFinishedTracerActivity.this.totalFnshQty.setText("完: " + String.valueOf(totalFnshQty));
