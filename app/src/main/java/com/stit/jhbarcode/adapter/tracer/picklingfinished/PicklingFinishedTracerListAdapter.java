package com.stit.jhbarcode.adapter.tracer.picklingfinished;
 ...
 *
 */
public class PicklingFinishedTracerListAdapter extends RecyclerView.Adapter<ListItemHolder> {
    private List<ApcJobOrde> jobOrdesList;
    private Activity activity;

    public PicklingFinishedTracerListAdapter(Activity activity, List<ApcJobOrde> jobOrdesList) {
