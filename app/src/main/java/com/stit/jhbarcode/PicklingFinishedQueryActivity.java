...
import com.stit.jhbarcode.adapter.PicklingFinishedListAdapter;
...
public class PicklingFinishedQueryActivity extends AppCompatActivity {
    private String title = "酸洗完工查詢";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pickling_finished_query);
    ...
    private void datePickerLsnr(View v) {
        ...
        if (TextUtils.isEmpty(this.scanDate.getText().toString())) {
            ...
            new DatePickerDialog(this, (view, year, month, dayOfMonth) -> {
                ...
                PicklingFinishedQueryActivity.this.scanDate.setText(dateFormatWithSlash.format(cal.getTime()));
            }, yy, mm, dd).show();
    ...
    private class MyTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            this.uploaded = PicklingFinishedQueryActivity.this.tbUploaded.isChecked();
            this.scanDate = PicklingFinishedQueryActivity.this.scanDate.getText().toString();
        }
            ...
            if (uploaded) {
                ...
                try {
                    String url = MyInfo.JH_API_URL +
                            "askCoilScanTemp" +
                            "?kind=" + Kind.PicklingFinished.getValue() +
                            "&scanDate=" + this.scanDate;

                    //System.out.println(url);

                    url = url.replaceAll(" ", "%20");
                    ApiResponse<List<MainData>> apiResponse = Ion.with(PicklingFinishedQueryActivity.this)
                            .load("GET", url)
                ...
                mainDataList = myDao.getMainDataList(Kind.PicklingFinished, _scanDate);
                return true;
            }
        }
        ...
        protected void onPostExecute(Boolean success) {
            ...
            if (success) {
                PicklingFinishedListAdapter adapter = new PicklingFinishedListAdapter(
                        PicklingFinishedQueryActivity.this,
                        mainDataList,
                        dsKind,
                        tvQueryCount
                );
