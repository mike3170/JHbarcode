...
import com.stit.jhbarcode.adapter.MatReturnListAdapter;
 ...
 * attn : codMastList
 */
public class MatReturnQueryActivity extends AppCompatActivity {
    private String title = "線材退料查詢";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mat_return_query);
        ...
        // load codMastList
        AsyncTask<Void, Void, Void> loadCodMastListTask = new AsyncTask<Void, Void, Void>() {
            @Override
            protected Void doInBackground(Void... voids) {
                MatReturnQueryActivity.this.codMastList =
                        MatReturnQueryActivity.this.myDao.getCodMastList(CodMastKind.AMRS);
                return null;
            }
        };
        loadCodMastListTask.execute();
    ...
    private void datePickerLsnr(View v) {
        ...
        if (TextUtils.isEmpty(this.scanDate.getText().toString())) {
            ...
            new DatePickerDialog(this, (view, year, month, dayOfMonth) -> {
                ...
                MatReturnQueryActivity.this.scanDate.setText(dateFormatWithSlash.format(cal.getTime()));
            }, yy, mm, dd).show();
    ...
    private class MyTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            this.uploaded = MatReturnQueryActivity.this.tbUploaded.isChecked();
            this.scanDate = MatReturnQueryActivity.this.scanDate.getText().toString();
        }
        ...
        protected Boolean doInBackground(Void... voids) {
            ...
            if (uploaded) {
                ...
                try {
                    ...
                    ApiResponse<List<MainData>> apiResponse = Ion.with(MatReturnQueryActivity.this)
                            .load("GET", url)
                ...
                mainDataList = myDao.getMainDataList(Kind.MatReturn, _scanDate);
                return true;
            }
        }
        ...
        protected void onPostExecute(Boolean success) {
            ...
            if (success) {
                MatReturnListAdapter adapter = new MatReturnListAdapter(
                        MatReturnQueryActivity.this,
                        mainDataList,
                        codMastList,
                        dsKind,
                        tvQueryCount
